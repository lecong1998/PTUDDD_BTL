...
import gst.trainingcourse.movie_home.entity.MostPopularTV.Item
import kotlinx.android.synthetic.main.item_movie_home.view.*

class TVPopularAdapter(var ClickItem: OnClickItem_TVPopular) : RecyclerView.Adapter<TVPopularAdapter.Viewholder>() {
    ...
    override fun onBindViewHolder(holder: Viewholder, position: Int) {
        ...
        holder.itemview.setOnClickListener {
            ClickItem.OnClickItem_PopularTV(m)
        }
    }
...
interface OnClickItem_TVPopular{
    fun OnClickItem_PopularTV(item: gst.trainingcourse.movie_home.entity.MostPopularTV.Item)
}