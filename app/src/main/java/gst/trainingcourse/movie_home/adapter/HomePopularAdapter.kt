...
import gst.trainingcourse.movie_home.entity.MostPopular.Item
import gst.trainingcourse.movie_home.entity.TopMovie.Film
import kotlinx.android.synthetic.main.item_movie_home.view.*

class HomePopularAdapter(var ClickItem : OnCLickItem_Popular) : RecyclerView.Adapter<HomePopularAdapter.Viewholder>() {
    ...
    override fun onBindViewHolder(holder: Viewholder, position: Int) {
        ...
        holder.itemview.setOnClickListener {
            ClickItem.OnClickItem_MostPopularMovie(m)
        }
    }
...
interface OnCLickItem_Popular{
    fun OnClickItem_MostPopularMovie(item: Item)
}